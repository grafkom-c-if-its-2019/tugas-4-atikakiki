...
(function(global) {
  ...
  function main() {
    ...
    function cube(){
      ...
      var ambientColor = glMatrix.vec3.fromValues(0.17, 0.00, 0.15);
    ...
    function triangle(){
      gl.useProgram(program);
            ...
            var gerak = gl.getUniformLocation(program, 'bounce');
      ...
      var ambientColor = glMatrix.vec3.fromValues(0.17, 0.41, 0.15);
